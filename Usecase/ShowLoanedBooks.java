 ...
 * ShowLoanedBooks 클래스
 * 
 * 현재 대출중인 도서 목록을 ID 오름차순으로 출력한다.
 * 정렬은 임시 리스트에서만 수행하며 DB 원본은 변경하지 않는다.
 */
public class ShowLoanedBooks
{
    private LibDB<Book> bookDB;
    private LoanMap loanMap;

    public ShowLoanedBooks(LibDB<Book> bookDB, LoanMap loanMap)
    {
        this.bookDB = bookDB;
